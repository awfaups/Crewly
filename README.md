...
- AI 队友支持自定义大模型配置
- AI 队友支持编辑配置和停用
- AI 队友在侧栏、消息、任务和详情中显示 AI 标识
- AI 队友拥有独立管理模块
- 每个 AI 队友拥有独立记忆、独立技能安装清单和技能调用策略
...
- AI 队友姓名旁显示 `AI` 徽标，便于和人类成员区分
- 可通过独立的 AI 队友管理模块集中查看、创建、编辑和停用 AI 队友
- 可为每个 AI 队友单独配置记忆范围、保留天数、已安装技能和调用策略
